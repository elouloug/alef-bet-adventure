...
export const LETTERS: Letter[] = [
  { id: 'alef',        name: 'Alef',        hebrew: 'א',  hebrewCursive: 'א',  pronunciation: 'אָלֶף',         phonetic: 'silent / ah',      isSofit: false },
  { id: 'beit',        name: 'Beit',        hebrew: 'בּ', hebrewCursive: 'ב',  pronunciation: 'בֵּית',         phonetic: 'b as in boy',      isSofit: false },
  ...
  { id: 'vav',         name: 'Vav',         hebrew: 'ו',  hebrewCursive: 'ו',  pronunciation: 'וָו',           phonetic: 'v as in vine',     isSofit: false },
  ...
  { id: 'kaf',         name: 'Kaf',         hebrew: 'כּ', hebrewCursive: 'כ',  pronunciation: 'כַּף',          phonetic: 'k as in kite',     isSofit: false },
  ...
  { id: 'pei',         name: 'Pei',         hebrew: 'פּ', hebrewCursive: 'פ',  pronunciation: 'פֵּא',          phonetic: 'p as in pop',      isSofit: false },
  ...
  { id: 'shin',        name: 'Shin',        hebrew: 'שׁ', hebrewCursive: 'ש',  pronunciation: 'שִׁין',         phonetic: 'sh as in ship',    isSofit: false },
  { id: 'sin',         name: 'Sin',         hebrew: 'שׂ', hebrewCursive: 'ש',  pronunciation: 'שִׂין',         phonetic: 's as in sun',      isSofit: false },
  { id: 'tav',         name: 'Tav',         hebrew: 'תּ', hebrewCursive: 'ת',  pronunciation: 'תָּו',          phonetic: 't as in tall',     isSofit: false },
